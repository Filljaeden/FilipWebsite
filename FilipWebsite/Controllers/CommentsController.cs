...
namespace FilipWebsite.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Body,Author,RecipeId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Body,Author,RecipeId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
